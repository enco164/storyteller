    ...
    ngAnnotateText.directive("ngAnnotateText", function($rootScope, $compile, $http, $q, $controller, $sce, NGAnnotation, NGAnnotateTextPopup) {
        return {
            ...
            postLink: function($scope, element, attrs) {
                var POPUP_OFFSET, activePopup, activeTooltip, clearPopup, clearPopups, clearSelection, clearTooltip, createAnnotation, loadAnnotationPopup, onAnnotationsChange, onClick, onMouseEnter, onMouseLeave, onSelect, popupTemplateData, ref, removeAnnotation, removeChildren, tooltipTemplateData;
                POPUP_OFFSET = (ref = $scope.popupOffset) != null ? ref : 10;
                activePopup = null;
                activeTooltip = null;
                popupTemplateData = "";
                tooltipTemplateData = "";
                ...
                removeChildren = function(annotation) {
                    var a, i, j, ref1, results;
                    results = [];
                    for (i = j = ref1 = annotation.children.length - 1; j >= 0; i = j += -1) {
                        a = annotation.children[i];
                        removeChildren(a);
                        results.push(a.children.splice(i, 1));
                    }
                    return results;
                };
